...
const Footer_child = () => {
    return (
        <>
            <footer id="footer">
                <div className=" h-[570px] max-sm:h-auto flex max-lg:flex-col bg-[#fafafa]">
                    ...
                    <div
                        ...
                        <div className=" h-1/2 mx-10 flex gap-5 items-center ">
                            <div
                                className="w-2/3 max-sm:w-full h-full max-lg:h-2/3 max-lg:w-1/2  flex flex-col gap-2 max-sm:gap-3 max-lg:flex ">
                                <div className="w-full h-1/2 max-lg:w-1/2 max-lg:h-1/2 max-sm:mt-1 max-lg:w-full">
                                    ...
                                    <p className="max-sm:mt-1 ml-5 footer_text max-xl:hidden">Số Giấy CNĐKDN:
                                        0108824877, đăng
                                        kí lần đầu ngày 17/07/2019.
                                        Nơi cấp: Sở kế hoạch và đầu tư thành phố Hà Nội - Phòng đăng kí kinh doanh</p>
                                </div>
                                <div className="w-full h-1/2 max-lg:w-1/2 max-lg:h-1/2 max-lg:w-full max-sm:mt-1">
                                ...
                                {/*    aa*/}
                                <div className="w-full h-auto max-sm:flex max-sm:block hidden">
                                    <div className="w-1/2  max-lg:mt-[30px] max-sm:mt-1">
                                        <h1 className="footer__title font-semibold max-xl:w-[200px]  ">Thông tin liên hệ
                                            -
                                            XLS</h1>
                                        <div className="flex ml-1 text-sm font-semibold py-2 max-xl:mx-0">
                                    ...
                                    <div className="w-1/2   max-lg:mt-[-15px] max-md:mt-1">
                                        <h1 className="footer__title font-semibold">Tổng đài hỗ trợ</h1>
                                        <div
                                            className="flex gap-5 py-1.5 footer_text font-semibold">
                                            <span className="font-bold">
                                        ...
                                        <div className="flex ml-5 my-5 text-4xl font-semibold max-lg:hidden">
                                    <span className="">
                            ...
                            <div className="w-1/3 h-full max-sm:hidden max-md:ml-10 max-sm:ml-0">
                                <div className="w-full h-1/2 max-lg:mt-[30px] max-sm:mt-1">
                                    <h1 className="footer__title font-semibold max-xl:w-[200px]  ">Thông tin liên hệ -
                                        XLS</h1>
                                    <div className="flex ml-5 text-sm font-semibold max-xl:mx-0">
                                ...
                                <div className="w-full h-1/2 max-lg:mt-[-15px] max-md:mt-1">
                                    ...
                                    <div className="flex ml-5 my-5 text-4xl font-semibold gap-2  max-lg:hidden">
                                    <span className="">
                                        <i className="fa-brands fa-facebook" style={{color: '#0168b7'}}></i>
                                    </span>
                                        <span className="">
                        ...
                        <div className="w-full h-1/2  border-t-[1.5px] flex gap-3  mt-5">
                            ...
                            <div className="w-1/2 h-full  mx-10">
