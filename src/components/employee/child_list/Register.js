                                    ...
                                    <Form>
                                        ...
                                        <div className="relative mb-4 h-11 w-full min-w-[200px]">
                                            <Field
                                                ...
                                                name="username"
                                                placeholder=""
                                                className="w-full h-full px-3 py-3 font-sans text-sm font-normal transition-all bg-transparent
                                                border rounded-md peer border-blue-gray-200 border-t-transparent text-blue-gray-700 outline
                                                focus:outline-white
                                                outline-0 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200
                                                focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:border-0
                                            ...
                                            font-normal leading-tight text-gray-500 transition-all before:pointer-events-none before:mt-[6.5px]
                                            ...
                                            after:border-r after:border-blue-gray-200 after:transition-all
                                        ...
                                        <div className="flex justify-between">
                                            <button
                                                ...
                                                className="block mb-2 w-full select-none bg-blue-700 rounded-lg  from-gray-900 to-gray-800 py-3 px-6 text-center align-middle
                                                 font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all
                                                  hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50
                                            ...
                                            <button
                                                ...
                                                onClick={() => resetForm()}
                                                disabled={isSubmitting}
                                                className="block mb-2 w-full select-none rounded-lg bg-gradient-to-tr from-gray-600 to-gray-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-600/10 transition-all hover:shadow-lg hover:shadow-gray-600/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2"
                                            >
                                                Làm mới
                                            </button>
                                        </div>
