                ...
                <tr className="w-1/12 h-[76px] " key={index}>
                  ...
                  <td className=" w-2/12 text-center ">
                    {landingItem.status === "Available" ? (
                      ...
                      <button className="w-auto h-[26px] bg-[#4CAF50] ">
                        <span className="text-[.70rem] font-semibold text-white flex">
                          Bàn Giao
                        </span>
                      </button>
                  ...
                  <td className="w-[76px] relative">
                    ...
                    >
                      <div className="w-full h-full py-2">
                        ...
                        <button className="w-full h-1/3 border-t-[1px] px-3 flex  hover:bg-[#fafafa]">
                        ...
                        <Link to={routes.editLanding + landingItem.id}>
                          <button className="w-full h-1/3 border-t-[1px] px-3 flex items-center hover:bg-[#fafafa]">
                            <span className="flex py-1">
                              <span className="mt-0.5 pr-3">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
