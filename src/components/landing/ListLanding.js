        ...
        <>
            <div className=" h-[90px]  mx-16 flex gap-5 items-center">
                ...
                <div className="w-1/5 h-1/2 flex gap-3  ">
                    ...
                    <button onClick={handleReset} className="rounded-full bg-[#2196f3] w-11 h-11 bg-[#2196f3]"><i
                                ...
                                <tr className="w-1/12 h-[76px] " key={index}>
                                    ...
                                    <td className=" w-2/12 text-center ">
                                        {locationMapping.hasOwnProperty(landingItem.status) ?
                                            <button className={`
                                    ${locationMapping[landingItem.status].trim() === "Chưa bàn giao" || locationMapping[landingItem.status].trim() === "Trống" ? "bg-green-500" : ''}
                                     ${locationMapping[landingItem.status].trim() === "Đã vào ở" || locationMapping[landingItem.status].trim() === "Đang sửa chữa" ? "bg-red-500" : ''}
            ...
            <div className=" h-[40px] my-5 relative mx-16 flex  ">
                <button className="left-0 relative w-[40px] h-[40px] bg-red-500 flex items-center justify-center rounded-full">
                    ...
                    <span className="absolute top-0 right-[-5px] w-[15px] h-[15px] text-black font-bold text-[10px]">10</span>
                </button>
