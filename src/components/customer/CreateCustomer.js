...
const CreateCustomer = () => {
    ...
    const validate = {
        ...
        companyName: Yup.string().required("Tên công ty không được rỗng").max(100,"TTên công ty không dài quá 100 kí tự").min(5,"Tên công ty dài hơn 5 kí tự"),
                                ...
                                <div class="-mx-3 flex flex-wrap">
                                    ...
                                    <div class="w-full px-3 sm:w-1/2">
                                        <div class="mb-5">
                                            ...
                                            />
                                            <ErrorMessage name='address' component='span' style={{color: 'red',fontStyle:'italic'}}></ErrorMessage>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="-mx-3 flex flex-wrap">
                                    <div className="w-full px-3 sm:w-1/2">
                                        <div className="mb-5">
                                            ...
                                            />
                                            <ErrorMessage name='dob' component='span' style={{color: 'red',fontStyle:'italic'}}></ErrorMessage>
                                        </div>
                                    </div>
                                    <div className="w-full px-3 sm:w-1/2">
                                        <div className="mb-5">
                                    ...
                                    <div className="w-full px-3 sm:w-1/2">
                                        <div className="mb-5">
                                            ...
                                            <Field
                                                ...
                                                className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                            />
                                            <ErrorMessage name='email' component='span' style={{color: 'red',fontStyle:'italic'}}></ErrorMessage>
                                    ...
                                    <div className="w-full px-3 sm:w-1/2">
                                        <div className="mb-5">
                                            ...
                                            <Field
                                                ...
                                                className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                            />
                                            <ErrorMessage name='companyName' component='span' style={{color: 'red',fontStyle:'italic'}}></ErrorMessage>
