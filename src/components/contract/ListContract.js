        ...
        <table class="table-auto  w-full h-full">
          <thead class="border ">
            <tr>
              <th> STT </th>
              <th>
                <button onClick={() => handleClickSortByField("cus.name")}>
                  Tên Khách Hàng
                </button>
              </th>
              <th>
                <button onClick={() => handleClickSortByField("l.code")}>
                  Mã Mặt Bằng
                </button>
              </th>
              <th>
                <button onClick={() => handleClickSortByField("start_date")}>
                  Ngày Bắt Đầu
                </button>
              </th>
              <th>
                <button onClick={() => handleClickSortByField("end_date")}>
                  Ngày Kết Thúc
                </button>
              </th>
              <th class="">
                  ...
                  >
                    <div class="w-full h-full py-2">
                      <Link
                        ...
                        class="w-full h-1/3  px-3 flex items-center hover:bg-[#fafafa]"
                      >
                      ...
                      <Link
                        onClick={() => toast("Tính năng này chưa phát triển !")}
                        class="w-full h-1/3  px-3 flex items-center hover:bg-[#fafafa]"
                      >
                        <span class="flex py-1">
                          <span class="mt-0.5 pr-3">
                          ...
                          <p style={{ border: "none" }}>Chi Tiết Hợp Đồng</p>
                        </span>
                      </Link>

                      <button
                        onClick={() => handleShowPopup(contract.id)}
