...
// lay danh sach mat bang con trong :
const getLandings = async () => {
  ...
  return (
    <>
     ...
     <div style={{position : 'relative' ,display : isOpenModalConfirmPassword || isOpenModalLoading ? 'none' : 'block'  }} className="w-full h-[600px] mt-[20px] ">
    ...
    {
                isOpenModalLoading ? <div id="modal-loading" class="border-gray-300 h-20 w-20 animate-spin rounded-full border-8 border-t-blue-600" /> : null
              }
    
      
      {
                    isOpenModalConfirmPassword ? <main
                    style={{
                      position : 'absolute',
                      display : "block",
                      top: '23%',
                    ...
                    id="content" role="main" class="w-full max-w-md mx-auto p-6">
                  <div class="mt-7 bg-white  rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-4 sm:p-7">
                      <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Xác Nhận Mật Khẩu </h1>
                      ...
                      <div class="mt-5">
                        <form>
                          <div class="grid gap-y-4">
                            <div>
                              <label for="email" class="block text-sm font-bold ml-1 mb-2 dark:text-white">Nhập Mật Khẩu :</label>
                              <div class="relative">
                                <input type="password" onChange={(e)=>setConfirmPassword(e.target.value)}  class="py-3 px-4 block w-full border-2 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm" required aria-describedby="email-error"/>
                              </div>
                              <p class="hidden text-xs text-red-600 mt-2" id="email-error">Please include a valid email address so we can get back to you</p>
                            </div>
                            <button type="submit" onClick={()=>handleSubmitPassword()} class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">Xác Nhận</button>
                            <button type="submit" onClick={()=>setIsOpenModalConfirmPassword(false)}  class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">Quay Lại</button>
                          </div>
                        </form>
                      </div>
                    </div>
